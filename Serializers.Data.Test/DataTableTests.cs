...
namespace Serializers.Data.Test
{
    ...
    public class When_RowStringFieldExistsInObject
    {
        ...
        {
            this.value1 = Any.StringValue(50);
            this.value2 = Any.StringValue(50);

            var table = new DataTable();
            table.Columns.Add(ColumnName, typeof(string));

            this.AddRow(table, this.value1);
            this.AddRow(table, this.value2);
        ...
        private void AddRow(DataTable table, string value)
        {
